...
y = df["利润（万）"]
z = df["产品名称"]
plt.scatter(x, y, s=y * 30, color="red", marker="o")
plt.xlabel('销售量', fontdict={'family': 'Microsoft YaHei',
                            'color': 'black',
                            'size': 20}, labelpad=20)
plt.ylabel('销售量与利润关系图', fontdict={'family': 'Microsoft YaHei',
                                  'color': 'black',
                                  'size': 20}, labelpad=20)
plt.title('销售量与利润关系图', fontdict={'family': 'Microsoft YaHei',
                                 'color': 'black',
                                 'size': 30}, loc='center')
